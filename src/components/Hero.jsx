...
const Hero = () => {
  return (
    ...
    <div id="template-mo-zay-hero-carousel" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="row p-5">
                        ...
                        <div className="col-lg-6 mb-0 d-flex align-items-center">
                            <div className="text-align-left align-self-center">
                                <h1 className="h1 text-success"><b>WeMart</b> eCommerce</h1>
                                <h3 className="h2">Tiny and Perfect eCommerce Template</h3>
                                <p>
                                    WeMart Shop is an eCommerce HTML5 CSS template with latest version of Bootstrap 5 (beta 1). 
                    ...
                    <div className="row p-5">
                        ...
                        <div className="col-lg-6 mb-0 d-flex align-items-center">
                            <div className="text-align-left">
                                ...
                                <p>
                                    You are permitted to use this WeMart CSS template for your commercial websites. 
        ...
        <Link className="carousel-control-prev text-decoration-none w-auto ps-3" to="#template-mo-zay-hero-carousel" role="button" data-bs-slide="prev">
            <i className="fas fa-chevron-left"></i>
        </Link>
        <Link className="carousel-control-next text-decoration-none w-auto pe-3" to="#template-mo-zay-hero-carousel" role="button" data-bs-slide="next">
